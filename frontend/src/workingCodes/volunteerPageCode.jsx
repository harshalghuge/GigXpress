...
const WorkerDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        <aside
          className={`${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-30 w-64 bg-white border-r transition-transform duration-300 ease-in-out shadow-xl lg:shadow-none`}
        >
          <div className="p-6 space-y-6 pt-4">
            <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl p-4 text-white shadow-lg transform transition-transform hover:scale-[1.02]">
              ...
              <div className="text-sm mb-3">
                12 more gigs to reach Professional level!
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {stats.map((stat, i) => (
                  <div
                    key={i}
                    className="group bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-transparent hover:border-indigo-100"
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div
                        className={`w-12 h-12 bg-gradient-to-r ${stat.color} rounded-lg flex items-center justify-center text-white shadow-lg transition-transform group-hover:rotate-12`}
                      >
                        <stat.icon size={24} />
                      </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="relative flex-1 group">
                  <Search
                    className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 transition-colors group-focus-within:text-indigo-600"
                    size={20}
                  />
                  <input
                    type="text"
              ...
              <div className="grid gap-6">
                {availableJobs.map((job) => (
                  <div
                    key={job.id}
                    className="group bg-white rounded-xl shadow-md p-6 hover:shadow-2xl transition-all duration-300 border-l-4 border-transparent hover:border-indigo-500 transform hover:-translate-y-1"
                  >
                    {job.urgent && (
                      <div className="mb-4">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div className="text-right">
                            <p className="text-3xl font-bold text-indigo-600 group-hover:scale-110 transition-transform origin-right">
                              {job.pay}
                            </p>
                      ...
                      <div className="flex lg:flex-col gap-2">
                        ...
                        <button
                          ...
                          className="flex-1 lg:flex-initial px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-semibold hover:brightness-110 hover:shadow-lg transition-all active:scale-95"
                        >
                          Apply Now
                        </button>

                        <button
                          className="px-4 py-3 border rounded-lg hover:bg-indigo-50 hover:text-indigo-600 transition-all active:scale-90"
                          title="Preview"
                        >
                          <Eye size={20} />
                        </button>
                        <button
                          className="px-4 py-3 border rounded-lg hover:bg-pink-50 hover:text-pink-600 transition-all active:scale-90"
                          title="Save"
                        >
                          <Heart size={20} />
                        </button>
                        <button
                          className="px-4 py-3 border rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-all active:scale-90"
                          title="Share"
                        >
                          <Share2 size={20} />
                        </button>
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-6">
                {myApplications.map((app) => (
                  <div
                    key={app.id}
                    className="group bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition-all duration-300 border border-transparent hover:border-indigo-100"
                  >
                    <div className="flex flex-col lg:flex-row justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-semibold transition-transform group-hover:scale-110 ${
                              app.status === "Accepted"
                    ...
                    <div className="flex flex-col lg:flex-row gap-6">
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div className="text-right">
                            <p className="text-2xl font-bold text-green-600 group-hover:scale-110 transition-transform origin-right">
                              {gig.earned}
                            </p>
                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                  <div className="relative group">
                    <img
                      src="https://i.pravatar.cc/150?img=5"
                      alt="Profile"
                      className="w-32 h-32 rounded-full border-4 border-white transition-transform group-hover:rotate-3"
                    />
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-white/90 mb-4">
                      Event Management Specialist • Pune, Maharashtra
                    </p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {badges.map((badge, i) => (
                    <div
                      key={i}
                      className={`group ${badge.color} rounded-xl p-6 text-center transition-all duration-300 hover:scale-105 hover:rotate-1 hover:shadow-lg cursor-pointer border border-transparent hover:border-white/50`}
                    >
                      <div className="text-5xl mb-3 transition-transform duration-500 group-hover:scale-125 group-hover:rotate-12 drop-shadow-sm">
                        {badge.icon}
                      </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                ...
                <div className="space-y-4">
                  {progressLevels.map((level, i) => (
                    <div
                      key={i}
                      className={`flex items-center gap-4 p-3 rounded-xl transition-all ${level.current ? "bg-indigo-50 shadow-sm" : "hover:bg-gray-50"}`}
                    >
                      <div
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-1">
                          <h4
                            className={`font-bold ${level.current ? "text-indigo-600" : "text-gray-600"}`}
                          >
                            {level.level}
                          </h4>
            ...
            <div className="space-y-6">
              ...
              <div className="grid sm:grid-cols-3 gap-6">
                {[
                  ...
                  <div
                    key={idx}
                    className="group bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-t-4 border-transparent hover:border-indigo-500"
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <div
                        className={`w-12 h-12 bg-gradient-to-r ${item.color} rounded-lg flex items-center justify-center text-white transition-transform group-hover:scale-110 group-hover:rotate-6`}
                      >
                        <item.icon size={24} />
                      </div>
                    ...
                    <p
                      className={`text-sm mt-2 ${item.label === "Total Earnings" ? "text-green-600" : "text-gray-500"}`}
                    >
                      {item.sub}
                    </p>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-4">
                  {completedGigs.map((gig) => (
                    <div
                      key={gig.id}
                      className="group flex items-center justify-between p-4 border rounded-lg hover:border-green-200 hover:bg-green-50/30 transition-all duration-200"
                    >
                      <div className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        <p className="font-bold text-gray-900 group-hover:scale-110 transition-transform">
                          {gig.earned}
                        </p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-lg p-12 text-center group hover:shadow-2xl transition-all duration-500 border-2 border-dashed border-gray-200 hover:border-indigo-300">
                ...
                <p className="text-gray-500 mt-2">
                  Browse the marketplace to find and apply for upcoming
                  opportunities.
                </p>
                <button
